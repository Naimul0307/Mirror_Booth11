...
<section class="section-3 py-5">
    <div class="container">
        <h2 class="title-color mb-4 h1 text-center">SOUVENIR BOOTHS DUBAI</h2>
        <div class="divider-container text-center">
            <div class="divider mb-3"></div>
        </div>
        <div class="cards">
            <div class="row">
                @if(!empty($limitedServices[4]))
                    @foreach ($limitedServices[4] as $service)
                        <div class="col-md-3 col-sm-6 mb-4">
                            <div class="card border-0 text-center">
                                @if(!empty($service->image))
                                    <img src="{{ asset('uploads/services/thumb/small/'.$service->image) }}" class="card-img-top" alt="">
        ...
        <div class="text-center mt-4">
            <a href="{{ url('/category/souvenir-booths-dubai') }}" class="btn btn-primary">SEE MORE SOUVENIR BOOTHS DUBAI</a>
        </div>
    </div>
</section>
