            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}" class="btn btn-primary">Home</a></li>
                        {{-- <li class="breadcrumb-item"><a href="{{ route('serviceExport') }}" class="btn btn-primary">Export</a></li> --}}
                    </ol>
                </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <a href="{{ route('reviews.create.from') }}" class="btn btn-primary">Create</a>
                            </div>
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <img src="{{ asset('uploads/review/thumb/small/'.$review->image) }}" width="50">
                                        @else
                                    ...
                                    <td>
                                        ...
                                        &nbsp;
                                        <a href="javascript:void(0);" class="" onclick="deleteReview({{ $review->id }});">
